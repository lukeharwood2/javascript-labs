writeRandomQuote = function () {
  let quotes = [
    ...
    "It is easier to find men who will volunteer to die. Than to find those who are willing to endure pain with patience. - Julius Casesar"
    ]
...
function copyDate() {
  ...
  let copyrightText = "Copyright [Luke] ©" + new Date().getFullYear()
